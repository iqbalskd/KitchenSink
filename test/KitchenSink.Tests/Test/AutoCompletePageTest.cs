...
namespace KitchenSink.Tests.Test
{
    ...
    class AutoCompletePageTest : BaseTest
    {
        ...
        public void AutoCompletePage_FillCountryNameThenSelectCountry()
        {
            ...
            Assert.IsTrue(WaitForText(_autoCompletePage.PlaceInfoLabel, "Capital of Poland is Warsaw", 15));
        }
        ...
        public void AutoCompletePage_FillProductNameThenSelectProduct()
        {
            ...
            Assert.IsTrue(WaitForText(_autoCompletePage.ProductsInfoLabel, "Bread costs $1", 15));
        }
    }
}
